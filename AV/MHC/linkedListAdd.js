...
$(document).ready(function() {
    ...
    var indexBox = av.ds.array(["0"], {indexed: false, top: -15, left: 40});

    av.label("value", {left: 0, top: 25});
    var valBox = av.ds.array(["42"], {indexed: false, top: 20, left: 40});
    ...
    indexBox.unhighlight();
    av.step();
  
    // Slide 3
    av.umsg(interpret("sc3"));
    pseudo.setCurrentLine("addFirst");
    l.get(0).highlight();
    av.step();
